...
//@FindBy(linkText = "swatikale1994@gmail.com")  WebElement googlegmailloginid;
...
//@FindBy(xpath = "swa$1435*")  WebElement googlegmailpassword;
...
//public void test(String googlegmailloginid, String googlegmailpassword  )
{
	...
	if (getStringData(data.get("Email or phone")).equalsIgnoreCase("Yes")) {
		...
		Assert.assertTrue(googlegmailloginid.getText().equalsIgnoreCase("swatikale1994@gmail.com"), " text mismatch");		
		//googlegmailloginid.click();
		//log.info("user is filled emailid");			
		googlegmailloginid.sendKeys(getStringData(data.get("swatikale1994@gmail.com")));
		...
		Assert.assertTrue(googlegmailpassword.getText().equalsIgnoreCase("swa$1435"), "text mismatch");		
		//googlegmailpassword.click();
		//log.info("user is filled password");			
		googlegmailpassword.sendKeys(getStringData(data.get("swa$1435")));
